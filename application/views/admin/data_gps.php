...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    <div class="x_title">
      <a href="<?php echo base_url('admin/tambah_gps')?>" class="btn btn-success"> + Tambah Data </a>
          ...
          <?php $no=1; foreach ($data_gps as $gps ) : ?>
            <tr>
              ...
              <td>
                  ...
                  <a href="<?php echo base_url('admin/edit_gps/'.$gps->id_gps);?>"><span data-placement='top' data-toggle='tooltip' title='Edit'><button class='btn btn-primary btn-xs' data-title='Edit' data-toggle='modal' data-target='#edit' ><span class='glyphicon glyphicon-pencil'></span></button><span></a>
                      
                  <a href="<?php echo base_url('admin/hapus_gps/'.$gps->id_gps);?>"><span data-placement='top' data-toggle='tooltip' title='Delete'><button onclick="return confirm('Anda yakin ingin menghapus data ini ?')" class='btn btn-danger btn-xs' data-title='Delete'><span class='glyphicon glyphicon-trash'></span></button></span></a>
              </td>   
