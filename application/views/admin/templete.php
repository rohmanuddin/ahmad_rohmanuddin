        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?php echo base_url('admin');?>" class="site_title"><i class="glyphicon glyphicon-book"></i> <span>GPS</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-clone"></i>Manage User <span class="fa fa-chevron-down"></span></a>
                  ...
                  <li><a><i class="fa fa-clone"></i> Manage GPS <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url('admin/data_gps');?>">Data GPS</a></li>
                    </ul>
                  </li>
